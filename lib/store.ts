...
import type { FileRecord, Folder, Gateway, ViewMode, StorageStats, ShareInfo } from "@/types";
...
interface StoredShareInfo extends ShareInfo {
  createdAt: number;
}
...
interface FileState {
  ...
  setShares: (shares: StoredShareInfo[] | ((prev: StoredShareInfo[]) => StoredShareInfo[])) => void;
